...
class ALPR():
    def __init__(self):
        ...
        self.model_recog = PaddleOCR(use_angle_cls=False, det=False, lang='en', use_gpu=False,
                                     ...
                                     show_log=False, cls_model_dir='./models/ch_ppocr_mobile_v2.0_cls_infer', use_tensorrt=False)
